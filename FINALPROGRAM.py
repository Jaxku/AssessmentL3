"""
Based off of Base v5, This is the final version of the Moari Quiz.
"""
...
response = requests.get(url="https://raw.githubusercontent.com/Jaxku/"
        ...
        if user_name:
            while True:
                ...
                if save_path:
                    ...
                    if messagebox.askyesno("Error", "No folder selected! Do "
                                                    "you want to abort "
                                                    "saving?"):
                        confirm_abort = messagebox.askyesno("Confirm Abort",
                                                            "Are you sure you "
                                                            "want to abort "
                                                            "saving the score?"
                                                            "")
